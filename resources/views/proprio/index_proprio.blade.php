        ...
        <div class="bg-brand-bgLight dark:bg-brand-bgDark w-full h-full rounded-2xl shadow-2xl overflow-y-auto no-scrollbar relative p-6 pb-10 transition-colors duration-300">
            ...
            <header class="flex justify-between items-center mb-8">
                <div>
                    ...
                    <h2 class="text-3xl font-bold text-gray-800 dark:text-white">Bonjour, Caleb 👋</h2>
                    <p class="text-gray-500 dark:text-gray-400 text-sm mt-1">Voici ce qui se passe sur vos zones aujourd'hui.</p>
                </div>
                ...
                <div class="relative group">
                    ...
                    <!-- Dropdown (Carte blanche en light, grise en dark) -->
                    <div class="absolute right-0 top-full mt-2 w-48 bg-brand-cardLight dark:bg-brand-cardDark rounded-xl shadow-xl p-2 hidden group-hover:block z-50 border border-gray-100 dark:border-gray-700">
                        ...
                        <div class="p-2 hover:bg-gray-50 dark:hover:bg-slate-700 rounded-lg cursor-pointer text-sm font-medium text-gray-500 dark:text-gray-400">Cyber Café (Hors ligne)</div>
                    </div>
                </div>
            </header>
