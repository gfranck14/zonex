...
<head>
    ...
    <title>Réinitialiser le mot de passe - Zonex Propriétaire</title>
...
<body class="min-h-screen flex flex-col items-center justify-center px-6 py-10">
    ...
    <div class="flex flex-col items-center mb-10 w-full max-w-xs">
        ...
        <p class="text-sm text-gray-500 mt-2 font-medium text-center">
            Créez un nouveau mot de passe pour votre compte propriétaire
        </p>
    </div>
    ...
    <div class="w-full max-w-xs">
        ...
        @else
            ...
            <form id="reset-form" method="POST" action="{{ url('/reset-password') }}" class="space-y-4">
                @csrf
